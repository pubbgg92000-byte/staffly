...
/**
 * Modal dialog. Thin wrapper around @radix-ui/react-dialog — the same
 * package that powers Sheet. API matches shadcn/ui Dialog so it can be
 * swapped in richer variants without touching call-sites.
 */
